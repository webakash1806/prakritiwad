            ...
            <form action=""
                ...
                <div className="flex flex-col items-start m-[0.5rem] xs:m-[0.5rem_1.5rem]">
                    ...
                    <input
                        ...
                        className="border bg-white w-full rounded-[3px] outline-none p-1 text-[16px]" />
                </div>
                <div className="flex flex-col items-start m-[0.5rem] xs:m-[0.5rem_1.5rem] font-[500]">
                    ...
                    <input placeholder="Enter password..." type="password" className="border bg-white w-full rounded-[3px] outline-none p-1" />
                </div>
