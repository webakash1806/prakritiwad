...
const Forget = () => {
    ...
    return (
            <div className='min-h-[90vh] flex items-center justify-center pb-20 text-white bg-[#f5f6f7]  w-[100vw]'>
                <form noValidate onSubmit={login} action="" className='relative h-[18rem] sm:py-8 py-[2rem] flex flex-col items-center justify-center gap-[9px] mt-[10rem] bg-[#1A202A] sm:p-14 p-[2rem] rounded-lg rounded-tl-none shadow-md shadow-[#6D75DE]'>
                    ...
                    <div className="flex flex-col items-start justify-center gap-[0.5px]">
                        ...
                        <input type="email" required
                            className='min-w-[17rem] sm:w-[25.5rem] rounded-[3px] border h-full border-[#2d3a4b] p-2 focus:border-[#745FDC]  outline-none bg-transparent text-[0.95rem] tracking-wide resize-none'
                            name='email'
                            id='email'
                    ...
                    <p className='mt-2'>Don&#39;t have an account? <Link to='/signup' className='underline text-[#FFB827]'>Register</Link></p>
