...
const Header = () => {
    ...
    return (
        <header className='flex w-full bg-white  md:pl-14 md:pr-6 lg:pl-16 lg:pr-8 lg:p-3 px-6 sm:px-10 text-black items-center justify-between z-[100] py-[6px] shadow-[-1px_1px_7px_#000] fixed top-0 left-0'>
            ...
            <nav className={` text-white bg-white md:border-0 shadow-[0px_160px_1000px_#12073ac5] md:shadow-none flex border-t-[#201154] border-t-2  p-4 pb-10 md:p-0 w-screen md:max-w-[80vw]  items-center justify-between gap-3 md:gap-0 flex-col absolute 
            ${barActive ? "top-[2.95rem] left-[-60rem] duration-[0.5s]" : "top-[2.85rem] left-0 duration-[0.5s]"}
             md:flex-row md:static `}>
                <div className="flex bg-white flex-col md:flex-row gap-3 md:gap-0 ">
